...
describe('Order', function() {
    ...
    it('case-9', function() {
        $('#edit-delivery-type > div:nth-child(2) > div').click();
        $('#edit-pickup > div:nth-child(3) > div').click();
        browser.pause(500);
        $('#edit-checkout').click();
    ...
    it('case-13', function() {
        ...
        $('#edit-customer-profile-billing-field-customer-recepient-profile > div > div > div#edit-customer-profile-billing-field-customer-recepient-profile > div > div > div').click()
        let drop = $('body > div:nth-child(19) > div > div > div:nth-child(2) > div');
        browser.pause(500);
        drop.click();
